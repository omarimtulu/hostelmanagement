   ...
   if (isset($_POST['search'])) {
    ...
    <?php
   	   if(mysqli_num_rows($result_search)==0){
   	   	  echo '<tr><td colspan="4">Roll Number has not applied or it does not exist</td></tr>';
   	   }
   	   else{
...
if(isset($_POST['submitallo'])){
   ...
   while($row1 = mysqli_fetch_assoc($result1)){
     ...
     $student_id = $row1['Student_id'];
     $query3 = "UPDATE Application SET Application_status = '0',Room_No = '$Roomno' WHERE Student_id = '$student_id'";
     $result3 = mysqli_query($conn,$query3);
     if($result3){
     	$room_id = $row2['Room_id'];
     	$query4 = "UPDATE Student SET Hostel_id = '$hostel_id',Room_id = '$Roomno' WHERE Student_id = '$student_id'";
     	$result4 = mysqli_query($conn,$query4);
     	if($result4){
			
			 $query5 = "UPDATE Room SET Allocated = '1' where Room_No = '$Roomno' and Hostel_id='$hostel_id'";
