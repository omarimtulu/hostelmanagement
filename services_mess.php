				...
				<div class="row wthree_banner_bottom_right_grids pr-sm-3">
					<div class="col-lg-3 col-sm-6 banner_bottom_right_grid">
						<div class="view view-tenth">
							<div class="agile_text_box">
								...
								<h3> Apply for AA-Mess</h3>
								<p>AA Mess</p>
							</div>
							<div class="mask">
								<a href="application_form_mess.php?id=A"><img src="web_home/images/n1.jpg" class="img-responsive" alt="" /></a>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-sm-6 mt-sm-0 mt-3 banner_bottom_right_grid">
						<div class="view view1 view-tenth">
							...
							<div class="mask">
								<a href="application_form_mess.php?id=B"><img src="web_home/images/n2.jpg" class="img-responsive" alt="" /></a>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-3 col-sm-6 mt-lg-0 mt-3 banner_bottom_right_grid">
						<div class="view view2 view-tenth">
							...
							<div class="mask">
								<a href="application_form_mess.php?id=C"><img src="web_home/images/n3.jpg" class="img-responsive" alt="" /></a>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-sm-6 mt-lg-0 mt-3 banner_bottom_right_grid">
						<div class="view view3 view-tenth">
							...
							<div class="mask">
								<a href="application_form_mess.php?id=D"><img src="web_home/images/n4.jpg" class="img-responsive" alt="" /></a>
							</div>
						</div>
					</div>
				...
				<div class="row wthree_banner_bottom_right_grids pr-sm-3">
					<div class="col-lg-3 col-sm-6 mt-sm-0 mt-3 banner_bottom_right_grid">
						<div class="view view1 view-tenth">
							...
							<div class="mask">
								<a href="application_form_mess.php?id=E"><img src="web_home/images/n2.jpg" class="img-responsive" alt="" /></a>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-3 col-sm-6 mt-lg-0 mt-3 banner_bottom_right_grid">
						<div class="view view2 view-tenth">
							...
							<div class="mask">
								<a href="application_form_mess.php?id=F"><img src="web_home/images/n1.jpg" class="img-responsive" alt="" /></a>
							</div>
						</div>
					</div>
					<div class="clearfix"> </div>
