          ...
          <legend>Appoint Hostel Manager</legend>
            <div class="agilecontactw3ls-grid">
              <div class="agile-con-centre">
                <form action="../includes/hm_hostel.php" method="POST">
                  <input type="text" name="hostelname" placeholder="BLOCK" required="required">
                  <input type="text" name="roomno" placeholder="ROOM NUMBER" required="required">
                  <input type="password" name="pass" placeholder="ADMIN PASSWORD" required="required">
                  <div class="send-button">
                    <input type="submit" name="hm_submit">
                  </div>
                </form>
              </div>
              <div class="clear"></div>
            ...
            <div class="agilecontactw3ls-grid">
              <div class="agile-con-centre">
                <form action="../includes/hm_hostel.php" method="POST">
                  ...
                  <input type="password" name="pass" placeholder="ADMIN PASSWORD" required="required">
                  <div class="send-button">
                    <input type="submit" name="remove_submit">
                  </div>
                </form>
              </div>
              <div class="clear"></div>
