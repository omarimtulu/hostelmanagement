...
<?php
   ...
   $hostel = isset($_GET['id']) ? $_GET['id'] : '';
   $amount = "";
   
   if(($hostel)=='A'){ $amount=5000;
   }elseif(($hostel)=='B'){ $amount=7000;
   }elseif(($hostel)=='C'){ $amount=5000;
   }elseif(($hostel)=='D'){ $amount=6000;
   }elseif(($hostel)=='E'){ $amount=7000;
   }elseif(($hostel)=='F'){ $amount=6500;
  }
				...
				<form action="payment_form.php" method="POST">
					<div class="row">
						...
						<!-- 	<div class="contact-fields-w3ls">
							...
							<div class="contact-fields-w3ls">
								<input type="text" name="Amount" placeholder="Amount" value="<?php echo $amount?>" required="" disabled="disabled">
							</div>
							<div class="contact-fields-w3ls">
...
<?php
   if(isset($_POST['submitfees'])){
     ...
     if(($status)==0){
		...
		if(!isset($_GET['A'])){ $amount=5000;
		}elseif(!isset($_GET['B'])){ $amount=7000;
		}elseif(!isset($_GET['C'])){ $amount=5000;
		}elseif(!isset($_GET['D'])){ $amount=6000;
		}elseif(!isset($_GET['E'])){ $amount=7000;
		}elseif(!isset($_GET['F'])){ $amount=6500;
	   }
		     ...
		     if($row = mysqli_fetch_assoc($result)){
		        ...
		        if($pwdCheck == false){
		            ...
		            $query3 = "INSERT INTO Payment VALUES ('$roll',1,'$amount')";
