...
<body>
    ...
    <div class=" w3l-login-form">
        ...
        <form action="includes/signup.inc.php" method="POST">
            ...
            <div class=" w3l-form-group">
                ...
                <div class="group">
                    ...
                    <input type="text" class="form-control" name="student_roll_no" placeholder="Reg No" required="required" />
                </div>
            </div>
            <div class=" w3l-form-group">
        ...
        <p class=" w3l-register-p">Already registered ?<a href="index.php" class="register"> Login</a></p>
    </div>
    <footer>
        <p class="copyright-agileinfo"> &copy; 2022 Omari Mtulu  Project. All Rights Reserved </p>
    </footer>
